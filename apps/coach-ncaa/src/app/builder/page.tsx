...
import { Search, ArrowLeft, Check, Save, Clock, Filter, ChevronDown, Star, X, BookMarked, ChevronLeft, ChevronRight, Target, Users, School, Repeat, Lightbulb, Zap, Printer } from 'lucide-react';
...
function SessionPreviewModal({ sessionTitle, sessionType, sessionDate, sessionSourceId, selectedExercises, exercises, onClose, onSaveSession, onSaveAsTemplate }: {
    sessionTitle: string;
    ...
    return (
        <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4 overflow-y-auto">
            <div className="bg-slate-800 rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col my-8 border border-slate-700 shadow-2xl print:bg-white print:text-black print:max-h-full print:my-0 print:rounded-none">
                {/* Header */}
